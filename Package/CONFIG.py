...
def MAIN_EXTRACT(args):
    ...
    ops.copyto(ops.path_join(src_lib_dir, "libaudit.so.1.0.0"), dst_lib_dir)
    ops.ln(dst_lib_dir, "libaudit.so.1.0.0", "libaudit.so.1.0")
    ops.ln(dst_lib_dir, "libaudit.so.1.0.0", "libaudit.so.1")
    ops.ln(dst_lib_dir, "libaudit.so.1.0.0", "libaudit.so")
    return True
